...
export default function SecondBanner() {
    return (
        <div className="hero md:h-[520px]" style={{ backgroundImage: 'url(https://i.ibb.co/fY3C26C/slider-2.jpg)' }}>
            <div className="hero-overlay bg-opacity-80"></div>
            <div className="hero-content text-center text-neutral-content md:px-12">
                <div className="hero h-full">
                    <div className="hero-content flex-col lg:flex-row-reverse">
                        <img src="https://i.ibb.co/cJtjyvq/hero-2.png" className="w-10/12 md:w-5/12 rounded-lg" />
