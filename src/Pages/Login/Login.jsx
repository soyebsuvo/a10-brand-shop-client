                ...
                <div className="flex flex-col w-10/12 md:w-6/12 border-opacity-50 bg-white rounded-lg py-6 mb-10">
                    <div className="grid card rounded-box place-items-center">
                        <div className='flex gap-5 py-5'>
                            <button className='flex justify-center items-center text-xl btn normal-case'><span className='hidden lg:block'>Login With Google</span> <FcGoogle></FcGoogle></button>
                            <button className='flex justify-center items-center text-xl btn normal-case'><span className='hidden lg:block'>Login With Github</span> <BsGithub></BsGithub></button>
                        </div>
                    </div>
